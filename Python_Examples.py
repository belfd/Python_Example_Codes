...
# Function attribute - is the ability to add an attribute to a function like to any object
...
'''
# *ARGS
# an operator we can pass to functions, can be called whatever we want, gather remaining arguments as tuple = Unpacking
...
'''
# list comprehensions instead of for loops examples
'''
...
# equivalent to using of for loops:
vals_exp = []
for x in vals:
    for y in x:
        vals_exp.append(y)
...
attirbute can be of instance and defined in __init__ function
attribute can be of instance and defined in other method
attribute can class attribute and known in class level: 
can be accessed as self.class_attribute inside the instance or <class_name>.class_attribute
Example:
...
'''
## The longest string in from a list
print("===========================")
